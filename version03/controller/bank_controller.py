...
class BankController:
    ...
    def bank_controller(self):
        ...
        """
        This function provides a command-line interface for users to either sign up for 
        a new bank account or log in to an existing account. It continuously prompts 
        the user for their choice until they decide to exit the system.
        """
